...
def main(argv):
    ...
    try:
        ...
        print('Error RoutingAlgorithm2.py -i <inputfile> -r <row> -o <outputfile>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('RoutingAlgorithm2.py -i <inputfile> -r <row> -o <outputfile>')
            sys.exit()
        elif opt in ("-i", "--ifile"):
    ...
    task.loadGraph()
    task.computeTime()
    print("RoutingAlgorithm2 completed!")
